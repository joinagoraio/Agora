-- Fix workspace_comments RLS policies
-- This script ensures workspace_comments has proper RLS policies and helper functions
...
-- 4. Create SELECT policy - users can view comments in workspaces within their spaces
...
-- 5. Create INSERT policy - users can create comments in workspaces within their spaces
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '================================';
  RAISE NOTICE '✅ WORKSPACE COMMENTS RLS FIX COMPLETE';
  RAISE NOTICE '================================';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '   - SELECT: Users can view comments in their spaces';
  RAISE NOTICE '   - INSERT: Users can create comments in their spaces';
  ...
  RAISE NOTICE '   2. Verify no RLS errors appear in console';
  RAISE NOTICE '';
END $$;
